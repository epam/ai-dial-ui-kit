...
export interface DialInputPopupProps {
  ...
  onOpen: () => void;
  disabled?: boolean;
  valueClassNamees?: string;
  inputClassNamees?: string;
  placeholder?: string;
  elementId?: string;
  errorText?: string;
  invalid?: boolean;
 ...
 *   disabled={false}
 *   valueClassNamees="custom-value-class"
 *   inputClassNamees="custom-input-class"
 ...
 * @param [valueClassNamees] - Additional CSS classes applied to the displayed value.
 * @param [inputClassNamees] - Additional CSS classes applied to the input container.
      ...
      >
        ...
        >
          <DialTooltip tooltip={value == null ? undefined : String(value)}>
            {value || !placeholder ? (
              <span className={valueClassNamees}>{value}</span>
            ) : (
