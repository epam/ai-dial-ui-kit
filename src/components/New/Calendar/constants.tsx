...
export const calendarFieldBaseClassName = // TODO: check after design review for input
  'flex w-full items-center justify-between gap-2 rounded-xl border border-secondary bg-layer-raised px-4 py-3 dial-small-text text-primary outline-none transition-colors hover:border-hover-alpha focus-within:border-accent-focus';
