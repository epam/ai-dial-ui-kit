export const SCHEME_JSON = {
    ...
    orchestrator: {
      properties: {
        deployment: {
          ...
          description:
            'The configuration for the orchestrator DIAL deployment.',
        },
        system_prompt: {
        ...
        max_iterations: {
          description:
            'The max count of orchestrator(agent) operations. Default: 15',
  ...
  required: ['orchestrator', 'contexts', 'tool_sets'],
  $defs: {
    ...
    OpenAiToolConfig_RestApiEndpointObjectParam_RestApiEndpointArrayParam_RestApiEndpointSimpleTypeParam_RestApiEndpointConstParam_:
      {
        ...
        required: ['function'],
        title:
          'OpenAiToolConfig[RestApiEndpointObjectParam, RestApiEndpointArrayParam, RestApiEndpointSimpleTypeParam, RestApiEndpointConstParam]',
        type: 'object',
      },
    ToolFallbackConfig: {
      properties: {
        ...
        display_error_in_stage: {
          default: true,
          description:
            'Whether to display exception message in the stage or just error notification.',
    ...
    StopStrategyModel: {
      properties: {
        trigger_on: {
          ...
          default: null,
          description:
            'The trigger on condition. If set as `null`, it will be applied to all tool errors.',
        },
        type: {
          const: 'stop',
          default: 'stop',
    ...
    ContentPropagation: {
      properties: {
        propagate_history: {
          default: false,
          description:
            'Flag to propagate messages to deployment. If True, the messages will be propagated in such way: [assistant, tool] -> [user, assistant].',
        ...
        propagate_headers: {
          ...
          default: null,
          description:
            'List of headers to propagate to the DIAL deployment. If None, the default headers will be used.',
    ...
    DialDeploymentTool: {
      properties: {
        ...
        system_prompt: {
          ...
          default: null,
          description:
            'The configuration for the system prompt used in the DIAL deployment tool.',
          title: 'System Prompt',
        },
        content_propagation: {
          anyOf: [
          ...
          default: null,
          description:
            'The configuration with propagations to DIAL deployment.',
        },
      },
      required: ['open_ai_tool', 'deployment'],
    ...
    PredefinedTool: {
      ...
      properties: {
        ...
        template_name: {
          description:
            "The name of the tool template file (without extension), e.g., 'rag_tool'.",
          title: 'Template Name',
          type: 'string',
        },
        enabled: {
    ...
    ToolStageConfig: {
      properties: {
        name: {
          ...
          default: null,
          description:
            'The name of the tool stage. Can contain placeholders for tool arguments in curly braces.',
          title: 'Name',
        },
        body: {
          anyOf: [
          ...
          default: null,
          description:
            'The body of the tool stage. Can contain placeholders for tool arguments in curly braces.',
          title: 'Body',
        },
        show: {
          default: true,
    ...
    FormattedParameterConfig: {
      properties: {
        ignore: {
          default: false,
          description:
            'Whether to show parameter with value in the stage content.',
          title: 'Ignore',
          type: 'boolean',
        },
        ...
        name: {
          ...
          default: null,
          description:
            'If present then will be used instead of original name, otherwise will be used original name.',
          title: 'Name',
        },
        prefix: {
          anyOf: [
          ...
          default: null,
          description:
            'The prefix to be added after parameter name and before parameter value.',
          title: 'Prefix',
        },
        suffix: {
          anyOf: [
        ...
        replaced_value_info: {
          ...
          default: null,
          description:
            'The replaced parameter value that will shown in the stage content.',
        ...
        format: {
          ...
          default: null,
          description:
            'The format of the parameter value. If present then the value will be wrapped in ```{format} {parameter value}```.',
          title: 'Format',
        },
      },
    ...
    OpenAiToolFunctionParameters_RestApiEndpointObjectParam_RestApiEndpointArrayParam_RestApiEndpointSimpleTypeParam_RestApiEndpointConstParam_:
      {
        ...
        title:
          'OpenAiToolFunctionParameters[RestApiEndpointObjectParam, RestApiEndpointArrayParam, RestApiEndpointSimpleTypeParam, RestApiEndpointConstParam]',
        type: 'object',
      },
    AttachmentConfig: {
      properties: {
        ...
        propagate_types_to_choice: {
          description:
            'List of attachment types to propagate from stage to choice.',
          items: {
            type: 'string',
          },
    ...
    OpenAiToolFunction_RestApiEndpointObjectParam_RestApiEndpointArrayParam_RestApiEndpointSimpleTypeParam_RestApiEndpointConstParam_:
      {
        ...
        title:
          'OpenAiToolFunction[RestApiEndpointObjectParam, RestApiEndpointArrayParam, RestApiEndpointSimpleTypeParam, RestApiEndpointConstParam]',
        type: 'object',
      },
    ...
    DialSystemPromptConfig: {
      properties: {
        ...
        path: {
          description:
            'Relative path to the the system prompt in DIAL, including bucket',
          title: 'Path',
          type: 'string',
        },
        variables: {
    ...
    DialDeploymentParameters: {
      properties: {
        temperature: {
          ...
          default: null,
          description:
            'The temperature for the model. A higher temperature means the model will take more risks.',
          title: 'Temperature',
        },
        top_p: {
          anyOf: [
          ...
          default: null,
          description:
            'The number of top tokens to sample from. A higher value means more randomness.',
          title: 'Top P',
        },
        seed: {
          anyOf: [
          ...
          default: null,
          description:
            "The seed for the model. Can be used for enhancing reproducibility of models' responses.",
          title: 'Seed',
        },
        stop: {
          anyOf: [
          ...
          default: null,
          description:
            'Up to 4 sequences where the Assistant will stop generating further tokens.',
          title: 'Stop',
        },
        n: {
          anyOf: [
        ...
        max_tokens: {
          ...
          default: null,
          description:
            'The maximum number of tokens to generate by the Assistant.',
          title: 'Max Tokens',
        },
        presence_penalty: {
          anyOf: [
        ...
        custom_fields: {
          ...
          default: null,
          description:
            'The configuration parameters for the DIAL deployment. Schema is defined for specific deployment via configuration endpoint',
        },
      },
